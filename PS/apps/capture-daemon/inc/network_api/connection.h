...
public:
	 ...
	 * @return число отправленных байт
	 */
	virtual std::int64_t send_data(const char *buffer, std::size_t lenght) const noexcept = 0;
	 ...
	 * @return число полученных байт данных
	 */
	virtual std::int64_t receive_data(char *buffer, std::size_t lenght) const noexcept = 0;
