...
// 	 * @param port порт
// 	 */
// 	explicit endpoint_ipv6(const std::uint16_t port);
//
// 	/**
...
// 	 * @param port порт
// 	 */
// 	endpoint_ipv6(const std::string &ip_address, const std::uint16_t port);
//
...
//
// 	endpoint_ipv6(const endpoint_ipv6 &copy);
//
// 	endpoint_ipv6 &operator=(const endpoint_ipv6 &copy);
//
// 	endpoint_ipv6(endpoint_ipv6 &&other);
//
// 	endpoint_ipv6 &operator=(endpoint_ipv6 &&other);
//
// private:
// 	struct sockaddr_in6 sock_address6_;  //!< структара ip версии 6
// };
//
