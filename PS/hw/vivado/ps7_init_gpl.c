...
unsigned long ps7_ddr_init_data_3_0[] = {
    ...
    // .. .. ==> 0XF800612C[19:10] = 0x000000B1U
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x0002C400U
    // .. .. 
    EMIT_MASKWRITE(0XF800612C, 0x000FFFFFU ,0x0002C409U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x9
    // .. .. ==> 0XF8006130[9:0] = 0x00000009U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000009U
    // .. .. reg_phy_gatelvl_init_ratio = 0xb2
    // .. .. ==> 0XF8006130[19:10] = 0x000000B2U
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x0002C800U
    // .. .. 
    EMIT_MASKWRITE(0XF8006130, 0x000FFFFFU ,0x0002C809U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x15
    // .. .. ==> 0XF8006134[9:0] = 0x00000015U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000015U
    // .. .. reg_phy_gatelvl_init_ratio = 0xbf
    // .. .. ==> 0XF8006134[19:10] = 0x000000BFU
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x0002FC00U
    // .. .. 
    EMIT_MASKWRITE(0XF8006134, 0x000FFFFFU ,0x0002FC15U),
    // .. .. reg_phy_wrlvl_init_ratio = 0xd
    // .. .. ==> 0XF8006138[9:0] = 0x0000000DU
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x0000000DU
    // .. .. reg_phy_gatelvl_init_ratio = 0xc5
    // .. .. ==> 0XF8006138[19:10] = 0x000000C5U
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x00031400U
    // .. .. 
    EMIT_MASKWRITE(0XF8006138, 0x000FFFFFU ,0x0003140DU),
    ...
    // .. .. reg_phy_wr_dqs_slave_ratio = 0x9
    // .. .. ==> 0XF8006154[9:0] = 0x00000009U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000009U
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006154, 0x000FFFFFU ,0x00000009U),
    // .. .. reg_phy_wr_dqs_slave_ratio = 0x9
    // .. .. ==> 0XF8006158[9:0] = 0x00000009U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000009U
    // .. .. reg_phy_wr_dqs_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006158, 0x000FFFFFU ,0x00000009U),
    // .. .. reg_phy_wr_dqs_slave_ratio = 0x15
    // .. .. ==> 0XF800615C[9:0] = 0x00000015U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000015U
    // .. .. reg_phy_wr_dqs_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF800615C, 0x000FFFFFU ,0x00000015U),
    // .. .. reg_phy_wr_dqs_slave_ratio = 0xd
    // .. .. ==> 0XF8006160[9:0] = 0x0000000DU
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x0000000DU
    // .. .. reg_phy_wr_dqs_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006160, 0x000FFFFFU ,0x0000000DU),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x86
    // .. .. ==> 0XF8006168[10:0] = 0x00000086U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000086U
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006168, 0x001FFFFFU ,0x00000086U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x87
    // .. .. ==> 0XF800616C[10:0] = 0x00000087U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000087U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF800616C, 0x001FFFFFU ,0x00000087U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x94
    // .. .. ==> 0XF8006170[10:0] = 0x00000094U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000094U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006170, 0x001FFFFFU ,0x00000094U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x9a
    // .. .. ==> 0XF8006174[10:0] = 0x0000009AU
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x0000009AU
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006174, 0x001FFFFFU ,0x0000009AU),
    // .. .. reg_phy_wr_data_slave_ratio = 0x49
    // .. .. ==> 0XF800617C[9:0] = 0x00000049U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000049U
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF800617C, 0x000FFFFFU ,0x00000049U),
    // .. .. reg_phy_wr_data_slave_ratio = 0x49
    // .. .. ==> 0XF8006180[9:0] = 0x00000049U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000049U
    // .. .. reg_phy_wr_data_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006180, 0x000FFFFFU ,0x00000049U),
    // .. .. reg_phy_wr_data_slave_ratio = 0x55
    // .. .. ==> 0XF8006184[9:0] = 0x00000055U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000055U
    // .. .. reg_phy_wr_data_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006184, 0x000FFFFFU ,0x00000055U),
    // .. .. reg_phy_wr_data_slave_ratio = 0x4d
    // .. .. ==> 0XF8006188[9:0] = 0x0000004DU
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x0000004DU
    // .. .. reg_phy_wr_data_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006188, 0x000FFFFFU ,0x0000004DU),
    // .. .. reg_phy_bl2 = 0x0
